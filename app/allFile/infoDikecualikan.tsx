...
const InfoDikecualikan = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://linyjayainformatika.co.id/ppid-bkad/api/informasi/4');
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.itemContainer}>
      <Link href={`modalView/DiKecualikan/${item.id}`} style={styles.link}>
...
export default InfoDikecualikan;
